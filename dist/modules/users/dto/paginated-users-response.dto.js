...
exports.PaginatedUsersResponseDto = void 0;
const openapi = require("@nestjs/swagger");
const swagger_1 = require("@nestjs/swagger");
const user_lite_dto_1 = require("./user-lite.dto");
...
class PaginatedUsersResponseDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { items: { required: true, type: () => [require("./user-lite.dto").UserLiteDto] }, pagination: { required: true, type: () => PaginationMeta } };
    }
}
exports.PaginatedUsersResponseDto = PaginatedUsersResponseDto;
__decorate([
    (0, swagger_1.ApiProperty)({ type: [user_lite_dto_1.UserLiteDto] }),
