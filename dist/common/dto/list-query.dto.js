...
class ListQueryDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { page: { required: false, type: () => Number, default: 1, minimum: 1 }, limit: { required: false, type: () => Number, default: 20, minimum: 1, maximum: 500 }, search: { required: false, type: () => String }, sortBy: { required: false, type: () => String }, sortOrder: { required: false, type: () => Object }, cursor: { required: false, type: () => String } };
    }
}
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Cursor for cursor-based paging' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], ListQueryDto.prototype, "cursor", void 0);
